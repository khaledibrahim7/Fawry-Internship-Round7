...
public class StreamsExample {
    ...
    public static void main(final String[] args) {
        ...
        // solved With functional interfaces declared
        Consumer<Author> activeAuthour = new Consumer<Author>() {
            @Override
            public void accept(Author author) {
                if (author.active)
                    System.out.println(author);
...
////////////////////////////////////////////
        ...
        Consumer<Book> collectPricesConsumer = book -> bookPrices.add((double) book.price);

        authors.stream()
                .flatMap(author -> author.books.stream())
                .forEach(collectPricesConsumer);

        double averagePrice = bookPrices.stream()
...
//////////////////////////////////////////////////
        ...
        Consumer<Author> printActiveAuthorsWithPublishedBook = author -> {
        ...
        authors.stream()
                .forEach(printActiveAuthorsWithPublishedBook);
